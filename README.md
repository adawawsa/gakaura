...
- 光の玉 = **経験値**。集めるとレベルアップし、3 択カードで強化を選ぶ
  - **衝撃波**: Lv3 でスラム衝撃波がビルを粉砕し XP に変わる
  - **磁力** / **滞空** / **韋駄天**
- コース上に致死障害物はなく、C1 を何周でも無限に走行できる
- 200 / 400 / 1,000 / 1,235 / 3,000 / 10,000 km/h で景観・音・カメラが段階的に変化する
- 高速域ではカーブで外側へ流される。重力同期を失っても死亡せず、速度を失って復帰する
- **スラム**: 空中で ↓ を押すと急降下。衝撃波があれば着地時に発動する
